# CuriOS dotfiles
This is CuriOS opinionated configurations files to set up a [COSMIC desktop environment](https://system76.com/cosmic/). It runs on a NixOS Linux distribution set-up as [CuriOS](https://github.com/CuriosLabs/CuriOS).
